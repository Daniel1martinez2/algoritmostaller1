...
public class CarCharView {
	...
	public void drawScreen1() {
		...
		app.fill(255);
		app.text("3.2s", 42, 70);
		app.text("15min", 42, 306);
		app.text("322mi", 42, 555);
	...
	public void comparo1() {
		...
		animation3compara();
		app.fill(255);
		app.text("3.9s", 240, 70);
		app.text("50min", 240, 306);
		app.text("280mi", 240, 555);
	}
	...
	public void comparo2() {
		...
		animation3compara();
		app.fill(255);
		app.text("2.3s", 240, 70);
		app.text("50min", 240, 306);
		app.text("200mi", 240, 555);
	...
	public void comparo3() {
		...
		animation3compara();
		app.fill(255);
		app.text("2.0s", 240, 70);
		app.text("45min", 240, 306);
		app.text("220mi", 240, 555);
	}
